            ...
            for StartColumn in range(Column - 2, Column + 1):
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        checkPatternString90 = PatternString[2:8] + PatternString[0:2] + PatternString[8]
                        checkPatternString180 = PatternString[4:8] + PatternString[0:4] + PatternString[8]
                        checkPatternString270 = PatternString[6:8] + PatternString[0:6] + PatternString[8]
                        ToCheck = [PatternString,checkPatternString90,checkPatternString180,checkPatternString270]
                        for i in ToCheck:
                            if P.MatchesPattern(i, CurrentSymbol):
