...
vowels = ["a","e","i","o","u"]
fruits_with_more_than_two_vowels = [fruit for fruit in fruits if len([item for item in fruit if item in vowels]) > 2]
print(fruits_with_more_than_two_vowels)
# Exercise 9 - make a variable named fruits_with_only_two_vowels. The result should be ['mango', 'kiwi', 'strawberry']
fruits_with_only_two_vowels = [fruit for fruit in fruits if len([item for item in fruit if item in vowels])==2]
...
multDigits = [number for number in numbers if number > 9 or number < -9]
print(multDigits)
